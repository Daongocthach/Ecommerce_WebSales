    ...
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, paddingX: 3 }}>
        ...
        <Link to={'/'} style={{ textDecoration: 'none' }}>
          <Typography variant="h5" fontWeight="bold" color={(theme) => (theme.palette.mode === 'dark' ? 'white' : '#333333')}> G2Store</Typography>
        </Link>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, paddingX: 3 }}>
        ...
        <Tooltip title="Notification">
          <Badge color="info" badgeContent={1} sx={{ cursor: 'pointer' }}>
